...
> **Tags:** `Windows` `Active Directory` `Responder` `LLMNR Poisoning` `LDAP Domain Dump` `ACL Abuse` `DCSync` `Pass-the-Hash`
...
![alt text](../../.gitbook/assets/group.png)
...
![alt text](../../.gitbook/assets/group2.png)

The only user within `Operators` is `fbeth103`.

![alt text](../../.gitbook/assets/operators.png)
