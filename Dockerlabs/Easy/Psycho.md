...
Identificamos un parámetro llamado `secret`, que efectivamente nos permite acceder a archivos locales del sistema. Probamos a visualizar el contenido de `/etc/passwd`.
...
Efectivamente, logramos obtener la clave `id_rsa` de uno de los usuarios, la cual guardamos en un archivo en la máquina atacante.
